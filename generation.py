"""
Generation utilities for facial anonymization.
Contains ComfyUI model loading and image generation functions.
"""
...
def process_and_generate_image(
    idx: int,
    total: int,
    image_path: str,
...
def main():
    ...
    print("\n" + "="*60)
    print("   FACIAL ANONYMIZATION GENERATION")
    print("="*60)
    ...
    processing_time = total_time - comfyui_load_time
