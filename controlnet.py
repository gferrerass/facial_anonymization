...
def main():
    ...
    with torch.inference_mode():
        ...
        modelpatchloader_9 = modelpatchloader.load_model_patch(
        ...
        qwenimagediffsynthcontrolnet = NODE_CLASS_MAPPINGS[
        ...
        for q in range(1):
            ...
            aio_preprocessor_10 = aio_preprocessor.execute(
                preprocessor="CannyEdgePreprocessor",
                resolution=512,
                image=get_value_at_index(inpaintcropimproved_13, 1),
            )

            qwenimagediffsynthcontrolnet_16 = (
                qwenimagediffsynthcontrolnet.diffsynth_controlnet(
                    strength=0.7,
                    model=get_value_at_index(differentialdiffusion_7, 0),
                    model_patch=get_value_at_index(modelpatchloader_9, 0),
                    vae=get_value_at_index(vaeloader_11, 0),
                    image=get_value_at_index(aio_preprocessor_10, 0),
                )
            )
            ...
            ksampler_21 = ksampler.sample(
                ...
                scheduler="normal",
                denoise=0.6,
                model=get_value_at_index(qwenimagediffsynthcontrolnet_16, 0),
